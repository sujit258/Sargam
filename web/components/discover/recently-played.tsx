      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {recentSongs.map((song) => {
          ...
          return (
            <div
              key={song.id}
              className="group relative flex items-center gap-3.5 rounded-xl border border-white/10 bg-card/30 p-2.5 backdrop-blur-sm transition duration-200 hover:border-primary/40 hover:bg-card/60"
            >
              <div className="relative size-14 shrink-0 overflow-hidden rounded-lg shadow">
                <img
